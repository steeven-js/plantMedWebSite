...
export default function PlanteLatestPostItem({ post, order, largePost }) {
  ...
  return (
    ...
    >
      <Image
        ...
        overlay={
          largePost
            ? `linear-gradient(to bottom, ${alpha(theme.palette.common.black, 0)} 0%, ${theme.palette.common.black
            } 100%)`
            : ''
        }
        sx={{ borderRadius: 2 }}
...
PlanteLatestPostItem.propTypes = {
